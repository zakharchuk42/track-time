<script setup>
import { currentPage, navigate } from '../modules/router.js'
import { isNavItemValid } from '../utils/validators.js'
import { computed } from 'vue'
import BaseIcon from './BaseIcon.vue'
import { PAGE_TIMELINE } from '../utils/constants.js'
...
const classes = computed(() => [
	'flex flex-col items-center p-2 text-xs capitalize transition-all',
