...
const typeClasses = {
	...
	[BUTTON_TYPE_WARNING]:
		'bg-yellow-500 enabled:hover:bg-yellow-600 text-white',
}
</script>

<script setup>
import { isButtonTypeValid } from '../utils/validators.js'
import { BUTTON_TYPE_PRIMARY } from '../utils/constants.js'
